...
namespace EGroceryStore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<EGroceryStoreDbContext>(options =>
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            app.UseCors(options =>
                   options.WithOrigins("https://localhost:4200").AllowAnyMethod().AllowAnyHeader());
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1.0/swagger.json", "EGrocery Api");
            });
